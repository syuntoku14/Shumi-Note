...
127. (2023/6/15) 劣勾配法: [notebooks/OPT_Grad_subgradient.ipynb](notebooks/OPT_Grad_subgradient.ipynb) 
128. (2023/6/16) 勾配法: [notebooks/OPT_Grad_convergence_basic.ipynb](notebooks/OPT_Grad_convergence_basic.ipynb) 
...
260. (2024/05/24) 全微分とフレシェ微分: [notebooks/OPT_Grad_convergence_basic.ipynb](notebooks/OPT_Grad_convergence_basic.ipynb)
...
275. (2024/07/20) （途中）近接勾配法: [notebooks/OPT_Grad_smooth_proximal_gradient.ipynb](notebooks/OPT_Grad_smooth_proximal_gradient.ipynb) 
276. (2024/07/28) （途中）大数の法則，中心極限定理: [notebooks/PROB_low_of_large_numbers.ipynb](notebooks/PROB_low_of_large_numbers.ipynb) 
277. (2024/08/04) （途中）一般化微分: [notebooks/OPT_Grad_generalized.ipynb](notebooks/OPT_Grad_generalized.ipynb) 
...
310. (2025/2/08) Proximal Gradient Descentの証明の続き: [notebooks/OPT_Grad_smooth_proximal_gradient.ipynb](notebooks/OPT_Grad_smooth_proximal_gradient.ipynb) 
311. (2025/2/10) 平均報酬でSpanが不要なリグレット（途中）: [notebooks/RL_AverageReward_NoSpan.ipynb](notebooks/RL_AverageReward_NoSpan.ipynb) 
312. (2025/2/11) UCRL2の実装: [notebooks/RL_AverageReward_UCRL2.ipynb](notebooks/RL_AverageReward_UCRL2.ipynb) 
313. (2025/2/12) バイアスを推定する平均報酬: [notebooks/RL_AverageReward_NoSpan_estimate-bias.ipynb](notebooks/RL_AverageReward_NoSpan_estimate-bias.ipynb) 
314. (2025/2/14) Median-of-Mean: [notebooks/PROB_median_mean.ipynb](notebooks/PROB_median_mean.ipynb) 
315. (2025/2/15) 平均報酬でSpanが不要なリグレット（実装途中）: [notebooks/RL_AverageReward_NoSpan.ipynb](notebooks/RL_AverageReward_NoSpan.ipynb) 
...
318. (2025/2/20) 平均報酬でspanがいらないサンプル効率: [notebooks/RL_AverageReward_NoSpan_sample-complexity.ipynb](notebooks/RL_AverageReward_NoSpan_sample-complexity.ipynb)
...
322. (2025/3/04) 平均報酬でspanがいらないサンプル効率（証明）: [notebooks/RL_AverageReward_NoSpan_sample-complexity.ipynb](notebooks/RL_AverageReward_NoSpan_sample-complexity.ipynb)
323. (2025/3/08) 平滑な関数の最適化について補足: [notebooks/OPT_Grad_convergence_basic.ipynb](notebooks/OPT_Grad_convergence_basic.ipynb)
...
343. (2025/5/30) リスク関数: [notebooks/PROB_risk_sensitive.ipynb](notebooks/PROB_risk_sensitive.ipynb)
...
* (2023/6/15) 劣勾配法: [notebooks/OPT_Grad_subgradient.ipynb](notebooks/OPT_Grad_subgradient.ipynb) 
* (2023/6/16) 勾配法: [notebooks/OPT_Grad_convergence_basic.ipynb](notebooks/OPT_Grad_convergence_basic.ipynb) 
